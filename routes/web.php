...
Route::middleware(['disableBack'])->group(function () {
    Route::middleware(['user_type:admin_kabupaten', 'auth'])->group(function () {
...
Route::middleware(['disableBack'])->group(function () {
    Route::middleware(['user_type:admin_kecamatan', 'auth'])->group(function () {
...
// Route::post('/logout', [App\Http\Controllers\Auth\LoginController::class, 'logout'])->name('logout')->middleware('clear-history');

Route::get('/home', [App\Http\Controllers\HomeController::class, 'index'])->name('home');
Route::post('/kader_dasawisma/logout', [KaderFormController::class, 'logoutPost'])->name('kader_dasawisma.logout');
Route::middleware(['disableBack'])->group(function () {
    Route::middleware(['user_type:kader_dasawisma', 'auth'])->group(function () {
        ...
        Route::resource('/data_kegiatan', DataKegiatanWargaController::class)->except(['update', 'destroy']);
