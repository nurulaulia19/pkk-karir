...
class AdminController extends Controller
{
    ...
    public function rekap_kelompok_pkk_rw(Request $request, $id)
    {
        ...
        $today = Carbon::now();
        $datart = Rt::with(['dasawisma.rumahtangga.anggotaRT.keluarga.anggota.warga', 'dasawisma.rumahtangga.anggotaRT.keluarga.anggota.warga'])
            ->where('rw_id', $id)
            ->get();
    ...
    public function loopingDataRt($id,$periode)
    {
        $countLakiLaki = 0;
        $countPerempuan = 0;
        // $countbalita = 0;
