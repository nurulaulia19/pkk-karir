                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body" style="margin: 70px">
                                    ...
                                    <h5 style="font-family: 'Times New Roman', Times, serif">1. Bintang</h5>
                                    <h5 style="font-family: 'Times New Roman', Times, serif">2. 17 butir kapas, 8 simpul
                                        pengikat dan 45 butir padi</h5>
                                    <h5 style="font-family: 'Times New Roman', Times, serif">3. Akolade melingkar</h5>
                                    <h5 style="font-family: 'Times New Roman', Times, serif">4. Rangkaian mata rantai</h5>
                                    <h5 style="font-family: 'Times New Roman', Times, serif">5. Lingkaran putih dengan
                                        tulisan Pemberdayaan dan Kesejahteraan Keluarga berwarna Hitam</h5>
                                    <h5 style="font-family: 'Times New Roman', Times, serif">6. 10 buah ujung tombak yang
                                        tersusun merupakan bunga.</h5>
                                    <br><br>
                                    ...
                                    <li>Gambar Akolade segilima</li><br><br>
                                    <i>Catatan:</i><br>
                                    <i>
                                        Khusus yang dicetak diatas logam warna kuning kunyit dan Akolade segilima dasar
                                        logam.
                                    </i><br><br>
                                    ...
                                    <li>17 butir kapas, 8 buah simpul pengikat, 45 butir padi melambangkan kemerdekaan RI
                                        dan</li>
                                    <li>Akolade melingkar, melambangkan wahana partisipasi masyarakat dalam pembangunan yang
                                        memadukan pelaksanaan segala kegiatan dan peraksara serta swadaya gotong royong
                                    ...
                                    <i>Pemberdayaan Pdan Kesejahteraan Keluarga (Pemberdayaan Dan Kesejahteraan Keluarga)
                                        ...
                                        Tuhan Ynag Maha Esa, melakukan
                                        kegiatan yang terus menerus berkesinambungan untuk menghimpun, menggerakkan da
                                        membina masyarakat dengan
                                        melaksanakan 10 Program Pokok Pemberdayaan dan Kesejahteraan Keluarga dengan sasaran
                                        Keluarga sebagai unit
                                        terkecil dalam masyarakat untuk mewujudkan keluarga sejahtera yang selalu hidup
                                        dalam suasana aman, damai, tertib,
                                        tentram, Makmur, dan sejahtera dalam ikatan Negara Kesatuan Repiblik Indonesia
