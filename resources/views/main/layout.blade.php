...
<body>
    ...
    <header id="header" class="header fixed-top" data-scrollto-offset="0">
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <a href="/" style="color: black" class="d-flex align-items-center"><img
                    src="{{ url('../image/remove.png') }}" style="padding: 10px 10px 10px 10px;" width="50px" />
                <span class="text-custom">PEMBERDAYAAN DAN KESEJAHTERAAN KELUARGA (PKK) KAB.INDRAMAYU</span>
            </a>
                ...
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Profile</span> <i
                        ...
                        <ul>
                            ...
                            <li class="dropdown"><a href="#"><span>Bagan Mekanisme Gerakan PKK</span> <i
                                        class="bi bi-chevron-down dropdown-indicator"></i></a>
                                <ul>
                                    <li>
                            ...
                            <li class="dropdown">
                                <a href="#"><span>Bagan Struktur TP PKK Dan Kelompok-Kelompok PKK</span>
                                    <i class="bi bi-chevron-right"></i></a>
                                <ul>
                                    <li>
                                        <a href="/pkk">Bagan Struktur TP PKK Kabupaten
                                        </a>
                                    </li>
                                    <li>
                    ...
                    <li class="dropdown">
                        <a href="#services"><span>POKJA</span>
                            <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            <li class="dropdown">
                                <a href="#"><span>Kelompok Kerja (POKJA) I</span>
                                    <i class="bi bi-chevron-right"></i></a>
                                <ul>
                            ...
                            <li class="dropdown">
                                <a href="#"><span>Kelompok Kerja (POKJA) II</span>
                                    <i class="bi bi-chevron-right"></i></a>
                                <ul>
                            ...
                            <li class="dropdown">
                                <a href="#"><span>Kelompok Kerja (POKJA) III</span>
                                    <i class="bi bi-chevron-right"></i></a>
                                <ul>
                            ...
                            <li class="dropdown">
                                <a href="#"><span>Kelompok Kerja (POKJA) IV</span>
                                    <i class="bi bi-chevron-right"></i></a>
                                <ul>
        ...
        <div class="footer-legal text-center">
            <div
                ...
                <div class="d-flex flex-column align-items-center align-items-lg-start">
                    <div class="copyright">
                        &copy; Copyright <strong><span>Tim Penggerak Pemberdayaan Kesejahteraan Keluarga (PKK) Kab.
                                Indramayu</span></strong>. All Rights Reserved
                    </div>
                    <div class="credits">
                        ...
                        Designed by Nisa Fadilah | Nurul Aulia Septiani</a>
                    </div>
                </div>

                <div class="social-links order-first order-lg-last mb-3 mb-lg-0">
                    <a href="https://www.facebook.com/profile.php?id=100075939237683" class="facebook"><i
                            class="bi bi-facebook"></i></a>
                    <a href="https://instagram.com/pkkkabupatenindramayu?utm_medium=copy_link" class="instagram"><i
