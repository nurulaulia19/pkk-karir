            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li
                            class="nav-item has-treeview {{ Request::is('kegiatan*', 'data_dusun*', 'rw*', 'data_dasawisma*') ? 'menu-open' : '' }}">
                            <a href="#"
                                class="nav-link {{ Request::is('kegiatan*', 'data_dusun*', 'rw*', 'data_dasawisma*') ? 'active' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="/data_dusun"
                                        class="nav-link {{ Request::is('data_dusun*') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Dusun</p>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="/data_dasawisma"
                                        class="nav-link {{ Request::is('data_dasawisma*') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Data Dasawisma</p>
                                    </a>
                                </li>
                        ...
                        <li
                            class="nav-item has-treeview {{ Request::is('data_kelompok_dasa_wisma*', 'data_kelompok_pkk_rt*', 'data_kelompok_pkk_rw*', 'dusun*', 'rekap_desa*') ? 'menu-open' : '' }}">
                            <a href="#"
                                class="nav-link {{ Request::is('data_kelompok_dasa_wisma*', 'data_kelompok_pkk_rt*', 'data_kelompok_pkk_rw*', 'dusun*', 'rekap_desa*') ? 'active' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="/data_kelompok_dasa_wisma"
                                        class="nav-link {{ Request::is('data_kelompok_dasa_wisma*') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Data Kelompok <br> Dasawisma</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/data_kelompok_pkk_rt"
                                        class="nav-link {{ Request::is('data_kelompok_pkk_rt') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Data Kelompok PKK RT</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/data_kelompok_pkk_rw"
                                        class="nav-link {{ Request::is('data_kelompok_pkk_rw') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                ...
                                <li class="nav-item">
                                    <a href="/rekap_desa"
                                        class="nav-link {{ Request::is('rekap_desa') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
