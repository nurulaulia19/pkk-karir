...
@section('container')
    <div class="container">
        <ul class="nav nav-tabs" id="dataDasawismaTabs" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" id="kader-tab" data-toggle="tab" href="#kader" role="tab" aria-controls="kader"
                    aria-selected="false">Data Kader</a>
            </li>
        </ul>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('nama_dasawisma') }}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('alamat_dasawisma') }}" required>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="id_rw" id="rw" required>
                                            ...
                                            @foreach ($rws as $rw)
                                                <option value="{{ $rw->id }}"
                                                    {{ old('id_rw') == $rw->id ? 'selected' : '' }}>{{ $rw->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn"
                                style="background-color: #50A3B9; color:white">Tambah</button>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (jenisKelaminSelect.value) {
                ...
                $.ajax({
                    ...
                    type: 'GET',
                    data: {
                        rw_id: jenisKelaminSelect.value
                    },
                    dataType: 'json',
                    success: function(data) {
                        ...
                        $.each(data, function(key, value) {
                            ...
                            $('#rt').append('<option ' + isSelected + ' value="' + key + '">' +
                                value + '</option>');
                        });
                    }
                });
