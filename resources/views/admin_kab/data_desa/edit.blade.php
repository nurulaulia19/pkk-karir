...
@section('title', 'Edit Data Desa | Super Admin PKK Kab. Indramayu')

@section('bread', 'Edit Data Desa')
@section('container')
                        ...
                        <select class="form-control" id="id_kecamatan" name="id_kecamatan">
                            @foreach ($kecamatans as $kecamatan)
                                <option value="{{ $kecamatan->id }}"
                                    {{ $kecamatan->id === $data_desa->id_kecamatan ? 'selected' : '' }}>
