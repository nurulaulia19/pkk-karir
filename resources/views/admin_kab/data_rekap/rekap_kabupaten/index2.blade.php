                        ...
                        <div class="card">
                            <div class="card-body">
                                <center>
                                    ...
                                    <h6><strong>KAB/KOTA :
                                            {{ strtoupper($kecamatans->first()->kabupaten->name ?? 'INDRAMAYU') }}</strong>
                                    </h6>
                                    <h6><strong>PROVINSI :
                                            {{ strtoupper($kecamatans->first()->kabupaten->provinsi->name ?? 'JAWA BARAT') }}</strong>
                                    </h6>
                                </center>
                                ...
                                <a href="{{ url('export_rekap_kab') }}?periode={{ $periode }}" target="_blank"
