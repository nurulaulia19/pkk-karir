      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #254336">
        ...
        <a href="/dashboard_kader" class="brand-link">
          <img
            ...
            style="opacity: 0.8"
          />
          <span class="brand-text font-weight-light" style="font-size: 14px">Kader Dasawisma <br> <span style="margin-left:56px">{{ (Auth::user()->name) }}</span></span><br>
        </a>
              ...
              <li class="nav-item has-treeview {{ Request::is('data_warga*','data_keluarga*','data_rumah_tangga*','data_kegiatan*','data_pemanfaatan*','data_industri*') ? 'menu-open' : '' }}">
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                      ...
                      <li class="nav-item">
                        <a href="/data_rumah_tangga" class="nav-link {{ Request::is('data_rumah_tangga*') ? 'active':'' }}">
                          <i class="far fa-circle nav-icon"></i>
                          <p>Rumah Tangga</p>
                        </a>
                      </li>
