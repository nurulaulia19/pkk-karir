...
@section('container')
    <div class="container">
        <ul class="nav nav-tabs" id="dataWargaTabs" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" id="warga-tab" data-toggle="tab" href="#warga" role="tab" aria-controls="warga"
                    aria-selected="false">Data Warga</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="aktivitas-warga-tab" data-toggle="tab" href="#aktivitas-warga" role="tab"
                    aria-controls="aktivitas-warga" aria-selected="false">Data Aktivitas Warga</a>
            </li>
        </ul>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>RW</label>
                                                <input type="hidden" class="form-control" name="rw_id" id="rw_id"
                                                    value="{{ $kader->dasawisma->rw_id }}">
                                                <input type="number" readonly class="form-control"
                                                    value="{{ $kader->dasawisma->rw->name }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>RT</label>
                                                <input type="hidden" class="form-control" name="rt_id" id="rt_id"
                                                    value="{{ $kader->dasawisma->rt_id }}">
                                                <input type="number" readonly class="form-control"
                                                    value="{{ $kader->dasawisma->rt->name }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group @error('alamat') is-invalid @enderror">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="alamat" id="alamat" placeholder="Isi Alamat"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="nama" id="nama" placeholder="Diisi dengan nama warga"
                                                ...
                                                <div class="kondisi_khusus"style="display: none;">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="d-flex">
                                                            <div class="form-check">
                                                                <input
                                                                    class="form-check-input @error('ibu_hamil') is-invalid @enderror"
                                                                    type="radio" name="ibu_hamil" id="ibu_hamil_ya"
                                                                    value=1 {{ old('ibu_hamil') == 1 ? 'checked' : '' }}>
                                                            ...
                                                            <div class="form-check ml-3">
                                                                <input
                                                                    class="form-check-input @error('ibu_hamil') is-invalid @enderror"
                                                                    type="radio" name="ibu_hamil" id="ibu_hamil_tidak"
                                                                    value=0 {{ old('ibu_hamil') == 0 ? 'checked' : '' }}>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="d-flex">
                                                            <div class="form-check">
                                                                <input
                                                                    class="form-check-input @error('ibu_menyusui') is-invalid @enderror"
                                                                    type="radio" name="ibu_menyusui"
                                                                    id="ibu_menyusui_ya" value=1
                                                                    {{ old('ibu_menyusui') == 1 ? 'checked' : '' }}>
                                                            ...
                                                            <div class="form-check ml-3">
                                                                <input
                                                                    class="form-check-input @error('ibu_menyusui') is-invalid @enderror"
                                                                    type="radio" name="ibu_menyusui"
                                                                    id="ibu_menyusui_tidak" value=0
                                                                    {{ old('ibu_menyusui') == 0 ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group @error('status_perkawinan') is-invalid @enderror">
                                                ...
                                                <select
                                                    ...
                                                    <option value="janda"
                                                        {{ old('status_perkawinan') == 'janda' ? 'selected' : '' }}>Janda
                                                    </option>
                                                    <option value="duda"
                                                        {{ old('status_perkawinan') == 'duda' ? 'selected' : '' }}>Duda
                                                    </option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group @error('agama') is-invalid @enderror">
                                                ...
                                                <select class="form-control @error('agama') is-invalid @enderror"
                                                    ...
                                                    <option value="kepercayaan lain"
                                                        {{ old('agama') == 'kepercayaan lain' ? 'selected' : '' }}>
                                            ...
                                            <div class="form-group @error('pendidikan') is-invalid @enderror">
                                                ...
                                                <select class="form-control @error('pendidikan') is-invalid @enderror"
                                                    ...
                                                    <option value="Tidak Tamat SD"
                                                        {{ old('pendidikan') == 'Tidak Tamat SD' ? 'selected' : '' }}>Tidak
                                                        Tamat SD</option>
                                                    <option value="SD/MI"
                                                        {{ old('pendidikan') == 'SD/MI' ? 'selected' : '' }}>SD/MI</option>
                                                    ...
                                                    <option value="Diploma"
                                                        {{ old('pendidikan') == 'Diploma' ? 'selected' : '' }}>Diploma
                                                    </option>
                                                    <option value="D4/S1"
                                                        {{ old('pendidikan') == 'D4/S1' ? 'selected' : '' }}>D4/S1</option>
                                                    <option value="S2"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group @error('pekerjaan') is-invalid @enderror">
                                                ...
                                                <option value="Lainnya">Lainnya</option> --}}
                                                    ...
                                                    <option value="Petani"
                                                        {{ old('pekerjaan') == 'Petani' ? 'selected' : '' }}>Petani
                                                    </option>
                                                    <option value="Pedagang"
                                                        {{ old('pekerjaan') == 'Pedagang' ? 'selected' : '' }}>Pedagang
                                                    </option>
                                                    <option value="Swasta"
                                                        {{ old('pekerjaan') == 'Swasta' ? 'selected' : '' }}>Swasta
                                                    </option>
                                                    <option value="Wirausaha"
                                                        {{ old('pekerjaan') == 'Wirausaha' ? 'selected' : '' }}>Wirausaha
                                                    </option>
                                                    <option value="TNI Polri"
                                                        {{ old('pekerjaan') == 'TNI Polri' ? 'selected' : '' }}>TNI Polri
                                                    </option>
                                                    <option value="PNS"
                                                        {{ old('pekerjaan') == 'PNS' ? 'selected' : '' }}>PNS</option>
                                                    <option value="Lainnya"
                                                        {{ old('pekerjaan') == 'Lainnya' ? 'selected' : '' }}>Lainnya
                                                    </option>
                                                </select>
                                            </div>
                                            @error('pekerjaan')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    placeholder="Diisi jabatan yang bersangkutan pada di struktural TP PKK"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    placeholder="Diisi Kota/Kabupaten tempat lahir yang bersangkutan"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date"
                                                    ...
                                                    name="tgl_lahir" id="tgl_lahir" placeholder="Diisi tanggal lahir"
                                                    data-date-format="mm/dd/yyyy" value="{{ old('tgl_lahir') }}"
                                                    required>
                                                @error('tgl_lahir')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group @error('makan_beras') is-invalid @enderror">
                                                ...
                                                <select class="form-control @error('makan_beras') is-invalid @enderror"
                                                    id="makan_beras" name="makan_beras">
                                                    <option selected disabled>Pilih Makanan Pokok</option>
                                                    {{-- <option value=1>Beras</option>
                                                <option value=0>Non Beras</option> --}}
                                                    <option value=1 {{ old('makan_beras') == 1 ? 'selected' : '' }}>Beras
                                                    </option>
                                                    <option value=0 {{ old('makan_beras') === 0 ? 'selected' : '' }}>Non
                                                        Beras</option>
                                                </select>
                                            </div>
                                            @error('makan_beras')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group @error('berkebutuhan_khusus') is-invalid @enderror">
                                                ...
                                                <select
                                                    class="form-control @error('berkebutuhan_khusus') is-invalid @enderror"
                                                    id="berkebutuhan_khusus" name="berkebutuhan_khusus">
                                                    <option selected disabled>Pilih</option>
                                                    @foreach (['Tidak', 'Cacat Mental', 'Cacat Fisik', 'Lainnya'] as $option)
                                                        <option value="{{ $option }}"
                                                            {{ old('berkebutuhan_khusus') == $option ? 'selected' : '' }}>
                                                            {{ $option }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group @error('ikut_kelompok_belajar') is-invalid @enderror">
                                        ...
                                        <option value="KF (Keaksaraan Fungsional)">KF (Keaksaraan Fungsional)</option> --}}
                                            ...
                                            <option value="Ya"
                                                {{ old('ikut_kelompok_belajar') == 'Ya' ? 'selected' : '' }}>Ya</option>
                                            <option value="Tidak"
                                                {{ old('ikut_kelompok_belajar') == 'Tidak' ? 'selected' : '' }}>Tidak
                                            </option>
                                            <option value="Paket A"
                                                {{ old('ikut_kelompok_belajar') == 'Paket A' ? 'selected' : '' }}>Paket A
                                            </option>
                                            <option value="Paket B"
                                                {{ old('ikut_kelompok_belajar') == 'Paket B' ? 'selected' : '' }}>Paket B
                                            </option>
                                            <option value="Paket C"
                                                {{ old('ikut_kelompok_belajar') == 'Paket C' ? 'selected' : '' }}>Paket C
                                            </option>
                                            <option value="KF (Keaksaraan Fungsional)"
                                                {{ old('ikut_kelompok_belajar') == 'KF (Keaksaraan Fungsional)' ? 'selected' : '' }}>
                                                KF (Keaksaraan Fungsional)</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="form-group @error('akseptor_kb') is-invalid @enderror">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" name="akseptor_kb" value="1"
                                                    class="form-check-input"
                                                    {{ old('akseptor_kb') == '1' ? 'checked' : '' }}>Ya
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" name="akseptor_kb" value="0"
                                                    class="form-check-input"
                                                    {{ old('akseptor_kb') == '0' ? 'checked' : '' }}>Tidak
                                            </label>
                                        </div>
                                        @error('akseptor_kb')
                                            <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" name="aktif_posyandu" value="1"
                                                    class="form-check-input"
                                                    {{ old('aktif_posyandu') == '1' ? 'checked' : '' }}>Ya
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" name="aktif_posyandu" value="0"
                                                    class="form-check-input"
                                                    {{ old('aktif_posyandu') == '0' ? 'checked' : '' }}>Tidak
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-check form-check-inline">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" name="ikut_bkb" value="1"
                                                    class="form-check-input"
                                                    {{ old('ikut_bkb') == '1' ? 'checked' : '' }}>Ya
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" name="ikut_bkb" value="0"
                                                    class="form-check-input"
                                                    {{ old('ikut_bkb') == '0' ? 'checked' : '' }}>Tidak
                                            </label>
                                        </div>
                                    </div>
                                    @error('ikut_bkb')
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="form-check form-check-inline">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" name="memiliki_tabungan" value="1"
                                                    class="form-check-input"
                                                    {{ old('memiliki_tabungan') == '1' ? 'checked' : '' }}>Ya
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" name="memiliki_tabungan" value="0"
                                                    class="form-check-input"
                                                    {{ old('memiliki_tabungan') == '0' ? 'checked' : '' }}>Tidak
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" name="ikut_paud_sejenis" value="1"
                                                    class="form-check-input"
                                                    {{ old('ikut_paud_sejenis') == '1' ? 'checked' : '' }}>Ya
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" name="ikut_paud_sejenis" value="0"
                                                    class="form-check-input"
                                                    {{ old('ikut_paud_sejenis') == '0' ? 'checked' : '' }}>Tidak
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" name="ikut_koperasi" value="1"
                                                    class="form-check-input"
                                                    {{ old('ikut_koperasi') == '1' ? 'checked' : '' }}>Ya
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" name="ikut_koperasi" value="0"
                                                    class="form-check-input"
                                                    {{ old('ikut_koperasi') == '0' ? 'checked' : '' }}>Tidak
                                            </label>
                                        </div>
                                    </div>
                                    @error('ikut_koperasi')
                                        ...
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" name="aktivitas_UP2K" value="1"
                                                    class="form-check-input"
                                                    {{ old('aktivitas_UP2K') == '1' ? 'checked' : '' }}>Ya
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" name="aktivitas_UP2K" value="0"
                                                    class="form-check-input"
                                                    {{ old('aktivitas_UP2K') == '0' ? 'checked' : '' }}>Tidak
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group @error('aktivitas_kesehatan_lingkungan') is-invalid @enderror">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" name="aktivitas_kesehatan_lingkungan"
                                                    value="1" class="form-check-input"
                                                    {{ old('aktivitas_kesehatan_lingkungan') == '1' ? 'checked' : '' }}>Ya
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" name="aktivitas_kesehatan_lingkungan"
                                                    ...
                                                    {{ old('aktivitas_kesehatan_lingkungan') == '0' ? 'checked' : '' }}>Tidak
                                            </label>
                                        </div>
                                    </div>
