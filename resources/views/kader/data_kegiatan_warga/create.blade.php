                            ...
                            <div class="form-group @error('id_kecamatan') is-invalid @enderror">
                                ...
                                @foreach ($kec as $c)
                                    ...
                                    <input type="text" disabled class="form-control" name="id_kecamatan"
                                        id="id_kecamatan" placeholder="Masukkan Nama Desa" value="{{ $c->nama_kecamatan }}">
                                @endforeach
                            </div>
                            @error('id_kecamatan')
                                <span class="invalid-feedback" role="alert">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('id_warga') is-invalid @enderror select-state"
                                    id="id_warga" name="id_warga" placeholder="Type to search.." required>
                                    {{-- nama warga --}}
