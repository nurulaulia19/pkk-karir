                                ...
                                <div class="table-responsive">
                                            ...
                                            @foreach ($keluarga->anggota as $index => $data_warga)
                                                <tr>
                                                    ...
                                                    <td style="vertical-align: middle;">
                                                        {{ ucfirst($data_warga->warga->nama) }}</td>
                                                    <td style="vertical-align: middle;">
                                                    ...
                                                    <td style="vertical-align: middle;">
                                                        {{ ucfirst($data_warga->warga->agama) }}</td>
                                                    <td style="vertical-align: middle;">
                                                        {{ ucfirst($data_warga->warga->pendidikan) }}
                                                    </td>
                                                    <td style="vertical-align: middle;">
                                                        {{ ucfirst($data_warga->warga->pekerjaan) }}
                                                    </td>
                                                    <td style="vertical-align: middle;">
                                                        {{ ucfirst($data_warga->warga->berkebutuhan_khusus) }}
                                                    </td>
                                                    @foreach ($dataKegiatan as $item)
                                                        @php
                                                            $ada = false;
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-success"
                                            href="{{ url('print_excel_cakel', $keluarga->id) }}?{{ http_build_query([
                                                'nama_dasawisma' => $dasawisma->nama_dasawisma,
                                                'rt' => $keluarga->rt,
                                                'rw' => $keluarga->rw,
                                                'periode' => $keluarga->periode,
                                            ]) }}"><i
                                                class="fas fa-print"></i> Cetak ke Excel</a>
                                    </td>
