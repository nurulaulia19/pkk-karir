            ...
            <form action="{{ route('data_pemanfaatan.store') }}" method="POST">
                ...
                <div class="card-body">
                            ...
                            <div class="form-group @error('id_kecamatan') is-invalid @enderror">
                                ...
                                @foreach ($kec as $c)
                                    <input type="hidden" class="form-control" name="id_kecamatan" id="id_kecamatan"
                                        placeholder="Masukkan Nama Kecamatan" required value="{{ $c->id }}">
                                    <input type="text" disabled class="form-control" name="id_kecamatan"
                                        id="id_kecamatan" placeholder="Masukkan Nama Kecamatan" required
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group @error('rumah_tangga_id') is-invalid @enderror">
                                ...
                                <select class="form-control select-state @error('rumah_tangga_id') is-invalid @enderror"
                                    id="rumah_tangga_id" name="rumah_tangga_id" placeholder="Type to search.." required>
                                    <option value=""> Pilih Kepala Rumah Tangga</option>
                                    @foreach ($krt as $rumahTangga)
                                        <option value="{{ $rumahTangga->id }}">{{ $rumahTangga->nama_kepala_rumah_tangga }}
                                            - {{ $rumahTangga->nik_kepala_rumah_tangga }}</option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="form-group" id="formContainer">
                        <div class="row">
                            <div class="col-md-12" class="@error('kategori_id') is-invalid @enderror">
                                ...
                                <select class="form-control selectNamaKegiatan @error('kategori_id') is-invalid @enderror"
                    ...
                    <div class="row d-flex justify-content-end mr-1">
                        <button type="button" id="addButton" class="btn"
